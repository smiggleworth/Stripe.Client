...
namespace Stripe.Client.Sdk.Models
{
    public class CountrySpec : IStripeModel
    {
        ...
        /// <summary>
        ///     Payment methods available in the specified country.You will need to enable bitcoin and ACH payments on your account
        ///     for those methods to appear in this list.The stripe payment method refers to charging through your platform.
        /// </summary>
        public string[] SupportedPaymentMethods { get; set; }

        /// <summary>
        ///     Lists the types of verification data needed to keep an account open.Includes ‘minimum’ fields, which every account
        ///     must eventually provide, as well as a ‘additional’ fields, which are only required for some merchants.
        /// </summary>
