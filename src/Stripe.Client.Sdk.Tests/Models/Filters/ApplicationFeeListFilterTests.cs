...
namespace Stripe.Client.Sdk.Tests.Models.Filters
{
    ...
    public class ApplicationFeeListFilterTests
    {
        ...
        [TestMethod]
        public void ApplicationFeeListFilter_CreatedDateTimeOverridesCreatedFilter()
        {
            // Arrange
        ...
        [TestMethod]
        public void ApplicationFeeListFilter_CreatedFilter()
        {
            // Arrange
